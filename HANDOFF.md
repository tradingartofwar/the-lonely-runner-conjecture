...
Next useful action: combine this recurrence and continued-fraction representation with small-subset upper bounds and exact witnesses to explain or disprove the plateau pattern. The interval-coverage-certificate question remains available. Follow Vance's next direction; no broad scan is authorized. Git history retains earlier stopping points.
