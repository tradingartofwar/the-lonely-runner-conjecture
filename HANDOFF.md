...
Next useful action: trace a small interval coverage certificate between successive valid touch times, preserving exceptional endpoints, and ask which speeds are essential away from peaks. Follow Vance's next direction; no broad scan is authorized. Git history retains earlier stopping points.
